...
export const roles: Role[] = [
  ...
  },
  {
    ...
    highlights: [
      "Led UI development for modernising a legacy lost-baggage tracing platform used by major airlines including American, Delta, and Southwest.",
      "Developed a new Angular 6 user interface and established frontend patterns for the application.",
      "Integrated REST APIs and backend services using Angular and Node.js.",
      "Worked with AWS and Jenkins CI/CD and developed end-to-end tests with Protractor.",
      "Used MySQL, npm, Yarn, Bootstrap, HTML5, and CSS3 across delivery.",
    ],
  },
  {
    company: "The Home Depot",
    ...
    highlights: [
      "Worked across internal Automation and HR engineering teams, building applications used across The Home Depot's store network.",
      "Automation team: built an internal UI for analysing operational and network data and submitting support requests with AngularJS, Angular Material, and D3.js.",
      "Built REST API and Node.js integrations with Redis caching; worked with Concourse CI/CD, Webpack, npm, Gulp, Karma, and Jasmine.",
      "HR and paperless onboarding: developed a React app supporting hiring and paperless employee onboarding across stores.",
      "Helped replace paper onboarding with secure digital workflows, including better handling of sensitive applicant information.",
      "Built and tested React functionality with Jest and Enzyme, deployed through PCF.",
      "Led React and Node.js development and taught other developers how to work effectively with both.",
    ],
  },
  {
